    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-3xl mx-auto px-4 py-6 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('content-queue') }}" class="text-sm font-medium text-hcrg-burgundy border border-hcrg-burgundy px-4 py-2 rounded-full hover:bg-hcrg-burgundy hover:text-white transition-colors">Suggestions</a>
