                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <div class="relative" id="configDropdown">
                            ...
                            <div id="configMenu" class="hidden absolute left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
                                ...
                                @if(auth()->user()->isSuperAdmin())
                                <p class="px-4 pt-3 pb-1 group-label">People</p>
                                ...
                                <a href="{{ route('admin.funding-approvers.index') }}" class="flex items-center px-4 py-2 text-sm {{ request()->routeIs('admin.funding-approvers.*') ? 'bg-hcrg-burgundy/10 text-hcrg-burgundy' : 'text-gray-700 hover:bg-gray-50' }}">
                                    Funding approvers
                                </a>

                                <p class="px-4 pt-3 pb-1 group-label">System</p>
