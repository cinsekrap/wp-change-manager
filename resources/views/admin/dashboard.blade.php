...
<div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
    ...
    <div class="bg-red-50 rounded-lg shadow p-6 ring-1 ring-red-100">
    ...
    <a href="{{ route('admin.requests.index', ['my_requests' => 1]) }}" class="bg-white rounded-lg shadow p-6 hover:ring-2 hover:ring-hcrg-burgundy hover:bg-gray-50 transition-all block">
