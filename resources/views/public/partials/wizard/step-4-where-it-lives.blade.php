...
<div class="card card-body wizard-step hidden" data-step="8" data-panel="where">
    ...
    <div class="pb-6 mb-6 border-b border-gray-100">
        <span class="field-label">What kind of content is this? <span class="text-red-500">*</span></span>
    ...
    <div class="mb-6">
        <span class="field-label">Its main home <span class="text-red-500">*</span></span>
        <p class="field-help">Where it gets written, reviewed and kept up to date. You picked this at step 1 — change it if this isn't really its home.</p>
        <div id="contentHomeSite" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 bg-white"></div>
    </div>

    <div class="mb-6">
        <span class="field-label">Might also work on <span class="text-gray-400">(optional)</span></span>
