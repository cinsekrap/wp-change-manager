...
<div class="bg-white rounded-lg shadow p-8 text-center">
    ...
    <p class="text-gray-600 mb-6">Hi {{ $approver->name }}, the web team has already progressed this change request ({{ $changeRequest->reference }}), so your approval is no longer needed.</p>
