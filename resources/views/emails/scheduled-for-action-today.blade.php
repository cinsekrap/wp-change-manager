...
@section('subject', "Scheduled for today: Change Request {$reference}")
...
@section('content')
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;border-collapse:collapse;">
        ...
        <tr>
            <td style="padding:8px 12px;border-bottom:1px solid #eeeeee;font-weight:600;color:#3C3C3B;">Scheduled for</td>
            <td style="padding:8px 12px;border-bottom:1px solid #eeeeee;color:#3C3C3B;">{{ $scheduledDate }}</td>
        </tr>
        <tr>
    ...
    <p style="margin:0 0 24px;">
        This change is scheduled to be actioned today. Please make the changes and mark the items done once complete.
    </p>
